...
export function QuestionDiv(){
  return (
    <>
    <div className="px-6 -mb-14 z-10 relative md:max-w-screen-xl md:mx-auto">
    <div className="w-full p-8 flex flex-col items-start gap-8 bg-gradient-to-r from-purple-50 to-purple-70 rounded-2xl md:flex-row md:items-center md:justify-between md:rounded-full">
    <div className="flex flex-row items-center gap-2">
      <QuestionIcon />
      <p className="text-base text-white-10">Ficou com alguma dúvida?<br/> Entre em contato com a PagEasy</p>
    </div>
    <button className="flex group items-center gap-2 transition-all duration-300 border border-white-10 group hover:bg-purple-10 px-6 py-2 rounded-3xl mt-6 md:mt-0"><p className="text-base text-blue-10 group-hover:text-purple-50">Comece agora</p></button>
    </div>
    </div>
...
const Footer = () =>{
  return (
    <>
    <QuestionDiv />
    <footer className="px-6 py-20 bg-blue-10 md:py-28 md:pb-16">
      <div className="md:max-w-screen-xl md:mx-auto md:flex md:items-start md:gap-8">
    ...
    <div className="my-8 w-full h-px bg-white-30 md:max-w-screen-xl md:mx-auto" />
    <div className="md:max-w-screen-xl md:mx-auto md:flex md:items-center md:justify-between">
